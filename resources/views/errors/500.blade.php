...
<head>
    ...
    <title>500 Internal Server Error | Municipality of Mabinay HRIS</title>
    ...
    <style>
        * {
        ...
        .error-code {
            ...
            font-weight: 800;
            line-height: 1;
            background: linear-gradient(135deg, #2dd4bf 0%, #0d9488 50%, #065f46 100%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            letter-spacing: -0.04em;
            text-shadow: 0 10px 30px rgba(13, 148, 136, 0.2);
        }
...
<body>
    ...
    <div class="error-card">
        ...
        <p class="error-description">
            We encountered an unexpected issue while processing your request. Our technical administration team has been logged of this event. Please try refreshing or return to the main dashboard.
        </p>
