...
class FaceAuditLog extends Model
{
     ...
     *
     * The actor is read off the web guard rather than passed in, so a caller
     * cannot accidentally attribute the action to the wrong person.
     */
    public static function record(int $employeeId, string $action, Request $request, array $meta = []): self
    {
        ...
        return static::create([
            ...
            'performed_by_name' => $actor ? trim("{$actor->fname} {$actor->lname}") : null,
